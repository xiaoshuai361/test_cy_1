#ifndef __USBH_OS_MIDDLEWARE_H
#define __USBH_OS_MIDDLEWARE_H
...
#define osMessageQueueId_t QueueHandle_t
#define osThreadId_t TaskHandle_t

extern void osMessageQueuePut(osMessageQueueId_t mq_id, const void *msg_ptr, uint8_t msg_prio, uint32_t timeout);
extern void Error_Handler(void);
extern int8_t osMessageQueueGet (osMessageQueueId_t mq_id, void *msg_ptr, uint8_t *msg_prio, uint32_t timeout);
