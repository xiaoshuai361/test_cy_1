...
void pstwo_task(void *pvParameters)
{
    ...
    {	
		...
		if(SysVal.HardWare_Ver==V1_0)//旧款ps2手柄读取
		{
			PS2_Read();
		}
		else if( SysVal.HardWare_Ver==V1_1 )
		{
			vTaskDelete(NULL);//新款usb接口ps2手柄不在此任务执行
		}
